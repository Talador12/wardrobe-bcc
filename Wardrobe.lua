...
Wardrobe.UI.OutfitFrame = CreateFrame("FRAME", "Wardrobe_Outfitframe", PaperDollFrame, "BackdropTemplate")
...
Wardrobe.UI.IconPickerFrame = CreateFrame("FRAME", "Wardrobe_IconPickerFrame", Wardrobe_Outfitframe, "BackdropTemplate")
...
Wardrobe.UI.QuickPanel = CreateFrame("FRAME", "WardrobeQuickPanel", UIParent, "BackdropTemplate")
